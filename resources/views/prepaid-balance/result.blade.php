<html>
    ...
    <body>
        ...
        <p class="font-label text-center">{{$data->total_order}}</p>
        <br>
        <p class="font-label text-center">your mobile phone number {{$data->phone_number}} will be topped up for {{$data->value_order}} after you pay</p>
